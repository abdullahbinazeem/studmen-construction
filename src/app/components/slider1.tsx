    ...
    <div className="lg:min-w-[450px] xl:min-w-[600px] max-w-[600px] aspect-[30/25] relative shrink-0">
      ...
      >
        <Image
          ...
          draggable={false}
          priority
          src="/assets/restorations/1/after.jpg"
          className="object-cover"
        />

        <div
          className="absolute top-0 left-0 right-0 w-full aspect-[30/25] m-auto overflow-hidden select-none"
        ...
        >
          <Image
            ...
            draggable={false}
            alt=""
            src="/assets/restorations/1/before.jpg"
            className="object-cover"
          />
        </div>
        <div
